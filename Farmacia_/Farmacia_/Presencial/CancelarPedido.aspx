<%@ Page Title="" Language="C#" MasterPageFile="~/SitePresencial.Master" AutoEventWireup="true" CodeBehind="CancelarPedido.aspx.cs" Inherits="Farmacia_.Presencial.CancelarPedido" %>
        ...
        <div class="col-md-3">
            ...
            <div class="list-group">
                ...
                <a class="list-group-item" href="RealizarPedido.aspx"><i class="glyphicon glyphicon-book"></i>&nbsp;Asignar pedido</a>
                                <a class="list-group-item" href="CancelarPedido.aspx"><i class="glyphicon glyphicon-book"></i>&nbsp;Cancelar pedido</a>
                 </div>
        </div>
        <div class="col-md-6">
